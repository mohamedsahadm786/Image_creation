"""
trace_html.py — 4-panel comparison viewer for the Qwen Step 2 experiment.
...
Renders chain.html with:
  ...
  Panel 4: Step 2 (Qwen)        — NEW (05_step2_qwen_final.jpg)

Plus the prompts used and a metadata strip with timing/cost.
Styling mirrors src/trace_html.py for consistency.
"""
...
def write_chain_html(out_dir: Path, record: dict) -> None:
    ...
    # ---- Image panel definitions ----
    # Step 0 source persona — chain.html sits at:
    #   experiments/step2_qwen_edit_2511/outputs/{ts}_{sid}/chain.html
    # so persona.jpg is 4 levels up + assets/persona.jpg
    if no_persona:
        step_0 = ("Step 0", "(no persona — flat-lay scenario)", None)
    else:
        step_0 = ("Step 0", "Source persona.jpg",
                  "../../../../assets/persona.jpg")
...
<head>
<meta charset="UTF-8">
<title>{html.escape(sc_id)} — Qwen Step 2 experiment</title>
<style>
